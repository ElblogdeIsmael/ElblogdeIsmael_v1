...
% \begin{figure}[h]
%     \centering
%     \fbox{\includegraphics[width=\textwidth]{Capitulos/Ejercicios_ISE_T1.pdf}}
%     \caption{Documento insertado con encabezados propios}
% \end{figure}
%\includepdf[pages=-]{Capitulos/Ejercicios_ISE_T1.pdf} 
